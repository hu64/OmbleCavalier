...
// ============================================================
// PESTO piece-square tables (a8=0 format, White's perspective)
// Positional bonus only — material values are in eval.hpp.
// White: use mirror(sq). Black: use sq directly.
// ============================================================
...
// Indexed by piece type (0=pawn … 5=king)
static const int *MG_PST[6] = {
    MG_PAWN_PST, MG_KNIGHT_PST, MG_BISHOP_PST,
    MG_ROOK_PST, MG_QUEEN_PST,  MG_KING_PST
};
static const int *EG_PST[6] = {
